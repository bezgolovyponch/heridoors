...
const PrivacyPolicyModal = ({ showModal, handleCloseModal }) => {
  return (
    showModal && (
      <div className="modal">
        <div className="modal-content">
          ...
          <div>
            ...
            <p>
              This Privacy Policy describes how Pragout group s.r.o. ("we,"
            ...
            <p>
              ...
              information about your interactions with our website or services,
              such as IP addresses, browser type, and pages visited.
            </p>
            <h3>Use of Information</h3>
            <p>
              We use the collected information to provide and improve our
              services, personalize user experiences, and communicate with users
              about their inquiries or requests.
            </p>
            <p>
            ...
            <p>
              Our website may contain links to third-party websites, which have
              their own privacy policies. We are not responsible for the content
